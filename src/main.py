...
st.set_page_config(page_title="Stock prediction analysis")
...
def run():
    ...
    with st.sidebar:        
        app = option_menu(
            ...
            options=['home','stock infos','account','about'],
            icons=['house-fill', 'file-text','person-circle', 'info-circle-fill'],
